                            ...
                            <form action="proses.php?aksi=update" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea type="text" id="editor1" class="form-control" rows="5" name="konten"
                                        required><?=$edit['konten']?></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="">Foto Artikel</label>
                                    <img src="img/<?=$edit['foto']?>" alt="">
                                    ...
                                    <select name="id_kategori" id="" class="form-control">
                                        <?php
                                                foreach ($artikel->get_kategori() as $data) {
                                                    if ($edit['id_kategori']==$data['id']) {
                                                    ?>
                                        <option value="<?php echo $data['id'] ?>" selected><?php echo $data['nama'] ?>
                                        </option>
                                        <?php }else {
                                            ?>
